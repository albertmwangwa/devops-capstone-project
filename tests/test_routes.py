...
class TestAccountRoutes(unittest.TestCase):
    ...
    def test_create_account(self):
        ...
        response = self.client.post(
            "/accounts", data=json.dumps(account_data), content_type="application/json"
        )
    ...
    def test_read_an_account(self):
        ...
        account_data = {"name": "Jane Smith", "email": "jane@example.com"}
    ...
    def test_list_all_accounts_with_data(self):
        ...
        self.client.post(
            "/accounts", data=json.dumps(account1_data), content_type="application/json"
        )
        self.client.post(
            "/accounts", data=json.dumps(account2_data), content_type="application/json"
        )
    ...
    def test_update_account_success(self):
        ...
        create_response = self.client.post(
            "/accounts", data=json.dumps(create_data), content_type="application/json"
        )
